...
SRC = os.path.join(ROOT, "data", "tokyo", "network.osm.pbf")
DST = os.path.join(ROOT, "data", "tokyo", "tokyo_city.osm.pbf")

BBOX = (139.66, 35.60, 139.84, 35.76)
...
def main():
    print("pass 1: finding ways and nodes inside the Tokyo box...")
    c = Collect()
